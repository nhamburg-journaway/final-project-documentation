...
Formulierungsvorschlag: Im Anschluss wurde mit Hilfe des objekt-relationalen Mappers (ORM) EFCore eine Migration angelegt, die die Tabellen,
Eigenschaften und Beziehungen zwischen Entitäten definiert. Diese Migration wurde auf die Datenbank angewandt.
...
Dafür wurder HubSpotApiClient implementiert, welcher Daten aus dem Domänen-Modell mappt und damit die Http-Requests ausführt. 
...
Vorschlag: Hier wäre eine kleine simple Abbildung hilfreich, um sich vorstellen zu können, wie die Abstraktionsebenen untereinander stehen.
Denk dran, dein Publikum enstammt zu 80 Prozent aus nicht technischen Bereichen. 
